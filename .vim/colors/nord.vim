...
call s:hi("Visual", "", s:nord2_gui, s:nord3_term, s:nord1_term, "", "")
call s:hi("VisualNOS", "", s:nord2_gui, s:nord3_term, s:nord1_term, "", "")
...
call s:hi("Structure", s:nord9_gui, "", s:nord9_term, "", s:bold, "")
