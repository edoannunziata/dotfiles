...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("Identifier", s:red, "", "bold")
	...
	call <SID>X("pythonAsync", s:purple, "", "")
	call <SID>X("pythonException", s:purple, "", "")
	call <SID>X("pythonFunction", s:blue, "", "bold")
	call <SID>X("pythonPreCondit", s:purple, "", "")
	call <SID>X("pythonExClass", s:orange, "", "")
	call <SID>X("pythonBuiltin", s:aqua, "", "")


	" JavaScript Highlighting
	call <SID>X("javaScriptBraces", s:foreground, "", "bold")
	...
	call <SID>X("gitcommitSummary", s:red, "", "bold")
