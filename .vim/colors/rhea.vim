...
function! s:color_role(color, ctermfg, ctermbg) abort
    let l:color = copy(a:color)
    let l:color.ctermfg = a:ctermfg
    let l:color.ctermbg = a:ctermbg
    return l:color
endfunction
...
if &background == 'dark'
    ...
    let s:light           = s:limited_cterm ? s:color_role(s:t_light_black, s:t_dark_white.cterm, s:t_dark_black.cterm) : s:t_light_black
    ...
    let s:bg              = s:color_role(s:t_light_white, s:t_light_white.cterm, "NONE")
    let s:bg_subtle       = s:limited_cterm ? s:color_role(s:t_dark_white, s:t_dark_black.cterm, s:t_dark_white.cterm) : s:t_dark_white
    let s:fg              = s:t_dark_black
    let s:norm            = s:t_light_black
    let s:light           = s:limited_cterm ? s:color_role(s:t_dark_white, s:t_dark_black.cterm, s:t_dark_white.cterm) : s:t_dark_white
...
function! s:h(group, style)
  execute "highlight" a:group
    ...
    \ "ctermfg=" (has_key(a:style, "fg")    ? s:ctermfg(a:style.fg) : "NONE")
    \ "ctermbg=" (has_key(a:style, "bg")    ? s:ctermbg(a:style.bg) : "NONE")
...
call s:h("StatusLineTerm",   {"bg": s:bg_subtle, "gui": s:bold, "cterm": s:bold})
call s:h("StatusLineTermNC", {"bg": s:bg_subtle, "fg": s:light})
...
call s:h("Conceal",          {"fg": s:light, "bg": s:bg_subtle})
call s:h("ToolbarLine",      {"bg": s:bg_subtle})
call s:h("ToolbarButton",    {"fg": s:fg, "bg": s:bg_subtle, "gui": s:bold, "cterm": s:bold})
